$(document).ready(function(){
	...
	$("#skillsIcon").hover(function(){
		$("#skillsCap").css('visibility', 'visible');
		$("#skillsCap").css('opacity', 1);
		
	}, function(){
		$("#skillsCap").css('opacity', 0);
		$("#skillsCap").css('visibility', 'hidden');
	});
	...
	$("#skillsIcon").click(function(){
		...
		setTimeout(function(){
			...
			$(".bioDataDiv").css('display', 'none');
			$(".portfolioDiv").css('display', 'none');
			$(".skillsDiv").css('display', 'inline-block');
		}, 501);
		setTimeout(function(){
